$(document).ready(function() {
    ...
    window.calculateSyrups = function() {
        ...
        const syrups = [
            ...
            { name: 'Chlorpheniramine (2 mg/5 ml) Syrup', dose: 0.1 * weight, concentration: 2 / 5, frequency: 3 },
            { name: 'Albuterol (2 mg/5 ml) Syrup', dose: 0.1, concentration: 2 / 5, frequency: 3 },
            { name: 'Dexamethasone (0.5 mg/5 ml) Syrup', dose: 0.2 * weight, concentration: 0.5 / 5, frequency: 3 },
            { name: 'Ketotifen (1 mg/5 ml) Syrup', dose: 0.05 * weight, concentration: 1 / 5, frequency: 1 },
